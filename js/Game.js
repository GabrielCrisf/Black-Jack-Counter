...
//Cria a Section: SEC_1
const  SEC_0= document.createElement('section')
SEC_0.classList.add('SEC_0');
div1.appendChild(SEC_0)

const  SEC_1= document.createElement('section')
SEC_1.classList.add('SEC_1');
div1.appendChild(SEC_1)

const t = document.createElement('p')
t.textContent = 'BlackJack Counter';
// t.style.position = 'Absolute';
t.classList.add('Titler')
SEC_1.appendChild(t);

const  SEC_2= document.createElement('section')
SEC_2.classList.add('SEC_0');
div1.appendChild(SEC_2)
...
for(let i=0;i<12;i++)
{
    ...
    if(i==1)
    {
        tmp.classList.add('Ace', 'Card');
        tmp=ConfigCard(tmp);
        SEC_0.appendChild(tmp);
    }

    if(i!=1 && i!=11)
    {
        tmp.classList.add('Nummer', 'Card');
        tmp=ConfigCard(tmp);
        SEC_1.appendChild(tmp);
    }
    ...
    if(i==11)
    {
        tmp.classList.add('Figure', 'Card');
        tmp=ConfigCard(tmp);
        SEC_2.appendChild(tmp);
    }
}
